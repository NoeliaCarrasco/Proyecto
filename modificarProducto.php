...
include_once("./db_configuration.php");
	...
	if ($resultado = $mysqli->query($consulta)) {
		if($resultado->num_rows > 0){
			$producto_elegido = $resultado->fetch_assoc();
		}
		$resultado->close();
	}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="checkout">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="mt-40">MODIFICAR PRODUCTO</h4>

                                        <form action="cambiarDatosProducto.php" method="post" enctype="multipart/form-data">

                                            <div class="row">

                                                <div class="form-group col-sm-8">
                                                    <label for="nombre">Nombre <span class="text-lightred" style="font-size: 15px">*</span></label>
                                                    <input name="nombre" type="text" class="form-control myInput" id="nombre" value="<?=$producto_elegido['NOMBRE']?>" required>
                                                    <input name="id" type="hidden" class="form-control myInput" id="id" value="<?=$producto_elegido['IDPRODUCTO']?>" required>
                                                </div>
												
                                                <div class="form-group col-sm-4">
                                                    <label for="stock">Stock<span class="text-lightred" style="font-size: 15px">*</span></label>
                                                    <input name="stock" type="number" class="form-control myInput" id="stock" value="<?=$producto_elegido['STOCK']?>" required>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-8">
                                                    <label for="categoria">Categoria <span class="text-lightred" style="font-size: 15px">*</span></label>
                                                ...
                                                <div class="form-group col-sm-4">
                                                    ...
                                                    <input name="precio" type="number" class="form-control myInput" id="precio" value="<?=$producto_elegido['PRECIO']?>" required>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <textarea name="descripcion" type="text" class="form-control myInput" id="descripcion" cols="10" rows="3" ><?=$producto_elegido['DESCRIPCION']?></textarea>
                                                </div>
                                            </div>
