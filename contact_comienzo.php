       ...
       <nav id="add-navbar">
            ...
            <div class="container clearfix">
                ...
                <ul class="divided">
                    ...
                    <li><a href="#" class="active mr-5">€</a><a href="#" class="mr-5">$</a>
        ...
        <section id="content">
            ...
            <div class="section gMap m-0" id="google-map">
                ...
                <script type="text/javascript" src="assets/js/vendor/gMap/jquery.gmap.min.js"></script>
                ...
                <script type="text/javascript">
                    ...
                    $('#google-map').gMap('addMarker', { latitude: 37.3852024, longitude: -5.9962673, content: 'Some HTML content' });
